        ...
        <div class="aside-menu">
            ...
            <div class="aside">
                <div :style="{backgroundColor: skinColor}" class="info">
                    <a href="https://microzz.com/" target="_blank" class="avatar"><img
                            src="https://microzz.com/img/avatar.jpg" alt="microzz.com"></a>
                    <div class="about">
              ...
              {{isSignIn ? '已签到' : '签到'}}
                ...
                <div class="settings">
                    <div class="content">
                        ...
                        <ul>
                            <li @click.stop.prevent="$store.commit('showIndex', false)"><i class="icon-skin"></i>个性换肤
                            </li>
